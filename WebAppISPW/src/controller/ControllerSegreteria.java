 ...
 */
	...
	public static ArrayList<PrenotazioneEventoBean> visualizzaPrenotazioniAttiveEvents(java.util.Date today,String userid,int ore) throws SQLException {
 ...
 *
 */
	public static ArrayList<PrenotazioneEventoBean> visualizzaStoricoPrenotazioniEvento(java.util.Date inizio,java.util.Date fine,String userid) throws SQLException {
